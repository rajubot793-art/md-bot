...
async function facebookCommand(sock, chatId, message) {
    try {
        ...
        try {
            const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𓄂𝐑𝐀𝐉𝐔 𝟒𝐗-𝐁𝐎𝐓\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐙𝐄𝐍𝐈𝐓𝐒𝐔-𝐁𝐎𝐓";
            ...
            try {
                ...
                // Send the video
                const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐙𝐄𝐍𝐈𝐓𝐒𝐔-𝐁𝐎𝐓\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𓄂𝐑𝐀𝐉𝐔 𝟒𝐗-𝐁𝐎𝐓";
